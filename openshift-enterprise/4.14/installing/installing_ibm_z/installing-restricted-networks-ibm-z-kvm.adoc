...
= Installing a cluster with {op-system-base} KVM on IBM Z(R) and {linuxoneProductName} in a restricted network
...
//# includes=_attributes/common-attributes,modules/installation-about-restricted-network,modules/cluster-entitlements,modules/installation-requirements-user-infra-ibm-z-kvm,modules/csr-management,modules/installation-network-user-infra,modules/installation-dns-user-infra,modules/installation-load-balancing-user-infra,modules/installation-infrastructure-user-infra,modules/installation-user-provisioned-validating-dns,modules/ssh-agent-using,modules/installation-initializing-manual,modules/installation-bare-metal-config-yaml,modules/installation-configure-proxy,modules/installation-three-node-cluster,modules/nw-operator-cr,modules/installation-user-infra-generate-k8s-manifest-ignition,modules/installation-ibm-z-kvm-user-infra-installing-rhcos,modules/ibm-z-secure-execution,modules/ibmz-configure-nbde-with-static-ip,modules/installation-ibm-z-kvm-user-infra-machines-iso,modules/installation-full-ibm-z-kvm-user-infra-machines-iso,modules/installation-user-infra-machines-static-network,modules/installation-installing-bare-metal,modules/cli-logging-in-kubeadmin,modules/installation-approve-csrs,modules/installation-operators-config,modules/olm-restricted-networks-configuring-operatorhub,modules/installation-registry-storage-config,modules/registry-configuring-storage-baremetal,modules/installation-registry-storage-non-production,modules/installation-complete-user-infra
