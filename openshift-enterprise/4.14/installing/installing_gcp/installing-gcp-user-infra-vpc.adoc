...
[source,python]
----
link:https://raw.githubusercontent.com/openshift/installer/release-4.14/upi/gcp/01_vpc.py[role=include]
----
====
...
[source,python]
----
link:https://raw.githubusercontent.com/openshift/installer/release-4.14/upi/gcp/02_lb_ext.py[role=include]
----
====
...
[source,python]
----
link:https://raw.githubusercontent.com/openshift/installer/release-4.14/upi/gcp/02_lb_int.py[role=include]
----
====
...
[source,python]
----
link:https://raw.githubusercontent.com/openshift/installer/release-4.14/upi/gcp/02_dns.py[role=include]
----
====
...
[source,python]
----
link:https://raw.githubusercontent.com/openshift/installer/release-4.14/upi/gcp/03_firewall.py[role=include]
----
====
...
[source,python]
----
link:https://raw.githubusercontent.com/openshift/installer/release-4.14/upi/gcp/03_iam.py[role=include]
----
====
...
[source,python]
----
link:https://raw.githubusercontent.com/openshift/installer/release-4.14/upi/gcp/04_bootstrap.py[role=include]
----
====
...
[source,python]
----
link:https://raw.githubusercontent.com/openshift/installer/release-4.14/upi/gcp/05_control_plane.py[role=include]
----
====
...
[source,python]
----
link:https://raw.githubusercontent.com/openshift/installer/release-4.14/upi/gcp/06_worker.py[role=include]
----
====
...
//# includes=_attributes/common-attributes,modules/csr-management,modules/cluster-entitlements,modules/installation-gcp-project,modules/installation-gcp-enabling-api-services,modules/installation-gcp-limits,modules/installation-gcp-service-account,modules/installation-gcp-permissions,modules/installation-gcp-regions,modules/installation-gcp-install-cli,modules/installation-machine-requirements,modules/installation-minimum-resource-requirements,modules/installation-gcp-tested-machine-types,modules/installation-using-gcp-custom-machine-types,modules/installation-gcp-user-infra-config-host-project-vpc,modules/installation-gcp-dns,modules/installation-creating-gcp-vpc,modules/installation-deployment-manager-vpc,modules/installation-user-infra-generate,modules/installation-initializing-manual,modules/installation-gcp-enabling-shielded-vms,modules/installation-gcp-enabling-confidential-vms,modules/installation-gcp-user-infra-shared-vpc-config-yaml,modules/installation-configure-proxy,modules/installation-user-infra-generate-k8s-manifest-ignition,modules/installation-extracting-infraid,modules/installation-user-infra-exporting-common-variables,modules/installation-network-user-infra,modules/installation-creating-gcp-lb,modules/installation-deployment-manager-ext-lb,modules/installation-deployment-manager-int-lb,modules/installation-creating-gcp-private-dns,modules/installation-deployment-manager-private-dns,modules/installation-creating-gcp-firewall-rules-vpc,modules/installation-deployment-manager-firewall-rules,modules/installation-creating-gcp-iam-shared-vpc,modules/installation-deployment-manager-iam-shared-vpc,modules/installation-gcp-user-infra-rhcos,modules/installation-creating-gcp-bootstrap,modules/installation-deployment-manager-bootstrap,modules/installation-creating-gcp-control-plane,modules/installation-deployment-manager-control-plane,modules/installation-gcp-user-infra-wait-for-bootstrap,modules/installation-creating-gcp-worker,modules/installation-deployment-manager-worker,modules/cli-installing-cli,modules/cli-logging-in-kubeadmin,modules/installation-approve-csrs,modules/installation-gcp-user-infra-adding-ingress,modules/installation-creating-gcp-shared-vpc-cluster-wide-firewall-rules,modules/installation-gcp-user-infra-completing,modules/cluster-telemetry
