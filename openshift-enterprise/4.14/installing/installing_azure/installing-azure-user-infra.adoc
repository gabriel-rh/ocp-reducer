...
[source,json]
----
link:https://raw.githubusercontent.com/openshift/installer/release-4.14/upi/azure/01_vnet.json[role=include]
----
====
...
[source,json]
----
link:https://raw.githubusercontent.com/openshift/installer/release-4.14/upi/azure/02_storage.json[role=include]
----
====
...
[source,json]
----
link:https://raw.githubusercontent.com/openshift/installer/release-4.14/upi/azure/03_infra.json[role=include]
----
====
...
[source,json]
----
link:https://raw.githubusercontent.com/openshift/installer/release-4.14/upi/azure/04_bootstrap.json[role=include]
----
====
...
[source,json]
----
link:https://raw.githubusercontent.com/openshift/installer/release-4.14/upi/azure/05_masters.json[role=include]
----
====
...
[source,json]
----
link:https://raw.githubusercontent.com/openshift/installer/release-4.14/upi/azure/06_workers.json[role=include]
----
====
...
//# includes=_attributes/common-attributes,modules/cluster-entitlements,modules/installation-azure-limits,modules/installation-azure-network-config,modules/installation-azure-increasing-limits,modules/csr-management,modules/installation-azure-subscription-tenant-id,modules/installation-azure-identities,modules/minimum-required-permissions-upi-azure,modules/installation-using-azure-managed-identities,modules/installation-creating-azure-service-principal,modules/installation-azure-regions,modules/installation-machine-requirements,modules/installation-minimum-resource-requirements,modules/installation-azure-tested-machine-types,modules/installation-azure-arm-tested-machine-types,modules/installation-azure-marketplace-subscribe,modules/installation-obtaining-installer,modules/ssh-agent-using,modules/installation-user-infra-generate,modules/installation-disk-partitioning-upi-templates,modules/installation-initializing,modules/installation-configure-proxy,modules/installation-user-infra-exporting-common-variables-arm-templates,modules/installation-user-infra-generate-k8s-manifest-ignition,modules/installation-azure-create-resource-group-and-identity,modules/installation-azure-user-infra-uploading-rhcos,modules/installation-azure-create-dns-zones,modules/installation-creating-azure-vnet,modules/installation-arm-vnet,modules/installation-azure-user-infra-deploying-rhcos,modules/installation-arm-image-storage,modules/installation-network-user-infra,modules/installation-creating-azure-dns,modules/installation-arm-dns,modules/installation-creating-azure-bootstrap,modules/installation-arm-bootstrap,modules/installation-creating-azure-control-plane,modules/installation-arm-control-plane,modules/installation-azure-user-infra-wait-for-bootstrap,modules/installation-creating-azure-worker,modules/installation-arm-worker,modules/cli-installing-cli,modules/cli-logging-in-kubeadmin,modules/installation-approve-csrs,modules/installation-azure-create-ingress-dns-records,modules/installation-azure-user-infra-completing,modules/cluster-telemetry
