...
//# includes=_attributes/common-attributes,snippets/technology-preview,modules/private-clusters-default,modules/snippets/snip-private-clusters-public-ingress,modules/private-clusters-about-ibm-power-vs,modules/installation-custom-ibm-power-vs,modules/snippets/custom-dns-server,modules/cluster-entitlements,modules/ssh-agent-using,modules/installation-obtaining-installer,modules/installation-ibm-cloud-export-variables,modules/installation-initializing-manual,modules/installation-minimum-resource-requirements,modules/installation-ibm-power-vs-config-yaml,modules/installation-configure-proxy,modules/manually-create-iam-ibm-cloud,modules/installation-launching-installer,modules/cli-installing-cli,modules/cli-logging-in-kubeadmin,modules/cluster-telemetry
