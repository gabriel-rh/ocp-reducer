...
//# includes=_attributes/common-attributes,snippets/technology-preview,modules/cluster-entitlements,modules/ssh-agent-using,modules/installation-obtaining-installer,modules/installation-ibm-cloud-export-variables,modules/installation-initializing,modules/installation-ibm-power-vs-config-yaml,modules/installation-configure-proxy,modules/manually-create-iam-ibm-cloud,modules/installation-launching-installer,modules/cli-installing-cli,modules/cli-logging-in-kubeadmin,modules/cluster-telemetry
