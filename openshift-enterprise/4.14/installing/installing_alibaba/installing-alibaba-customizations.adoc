...
//# includes=_attributes/common-attributes,snippets/technology-preview,modules/cluster-entitlements,modules/ssh-agent-using,modules/installation-obtaining-installer,modules/installation-initializing,modules/manually-creating-alibaba-manifests,modules/cco-ccoctl-creating-at-once,modules/installation-alibaba-config-yaml,modules/installation-configure-proxy,modules/installation-launching-installer,modules/cli-installing-cli,modules/cli-logging-in-kubeadmin,modules/logging-in-by-using-the-web-console,modules/cluster-telemetry
