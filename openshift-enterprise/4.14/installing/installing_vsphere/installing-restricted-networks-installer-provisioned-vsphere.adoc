...
//# includes=_attributes/common-attributes,snippets/vcenter-support,modules/installation-about-restricted-network,modules/cluster-entitlements,modules/installation-vsphere-infrastructure,modules/installation-vsphere-installer-network-requirements,modules/vmware-csi-driver-reqs,modules/installation-vsphere-installer-infra-requirements,modules/installation-vsphere-installer-infra-static-ip-nodes,modules/snippets/technology-preview,modules/ssh-agent-using,modules/installation-adding-vcenter-root-certificates,modules/installation-creating-image-restricted,modules/installation-vsphere-regions-zones,modules/installation-initializing,modules/installation-installer-provisioned-vsphere-config-yaml,modules/installation-configure-proxy,modules/configuring-vsphere-regions-zones,modules/installation-launching-installer,modules/cli-installing-cli,modules/cli-logging-in-kubeadmin,modules/olm-restricted-networks-configuring-operatorhub,modules/registry-removed,modules/installation-registry-storage-config,modules/registry-configuring-storage-vsphere,modules/cluster-telemetry,modules/nw-osp-configuring-external-load-balancer
