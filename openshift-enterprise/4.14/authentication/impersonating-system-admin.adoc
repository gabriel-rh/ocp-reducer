...
//# includes=_attributes/common-attributes,modules/authentication-api-impersonation,modules/impersonation-system-admin-user,modules/impersonation-system-admin-group
