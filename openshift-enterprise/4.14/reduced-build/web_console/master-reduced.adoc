...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/about/#cluster-administrator[Learn more about Cluster Administrator]
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/getting_started/#for-administrators[Overview of the *Administrator* perspective]
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/building_applications/#odc-creating-applications-using-developer-perspective[Creating and deploying applications on {product-title} using the *Developer* perspective]
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/building_applications/#odc-viewing-application-composition-using-topology-view[Viewing the applications in your project, verifying their deployment status, and interacting with them in the *Topology* view]
* xref:using-dashboard-to-get-cluster-info[Viewing cluster information]
* xref:configuring-web-console[Configuring the web console]
* xref:customizing-web-console[Customizing the web console]
* xref:customizing-web-console[About the web console]
* xref:odc-using-web-terminal[Using the web terminal]
* xref:creating-quick-start-tutorials[Creating quick start tutorials]
* xref:disabling-web-console[Disabling the web console]
...
[role="_additional-resources"]
.Additional resources
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/nodes/#[Enabling feature sets using the web console]
...
[role="_additional-resources"]
.Additional resources
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/security_and_compliance/#understanding-service-serving_service-serving-certificate[Understanding service serving certificates]
