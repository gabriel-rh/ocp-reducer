...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/operators/#crd-extending-api-with-crds[Extending the Kubernetes API with custom resource definitions]
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/operators/#crd-managing-resources-from-crds[Managing resources from custom resource definitions]
...
//# includes=about/about-serverless,about/_attributes/common-attributes
