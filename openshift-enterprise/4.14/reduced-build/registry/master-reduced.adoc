...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/nodes/#nodes-scheduler-pod-topology-spread-constraints[Configuring pod topology spread constraints]
...
* xref:configuring-registry-storage-aws-user-infrastructure[Configuring the registry for AWS user-provisioned infrastructure]
* xref:configuring-registry-storage-gcp-user-infrastructure[Configuring the registry for GCP user-provisioned infrastructure]
* xref:configuring-registry-storage-azure-user-infrastructure[Configuring the registry for Azure user-provisioned infrastructure]
* xref:configuring-registry-storage-baremetal[Configuring the registry for bare metal]
* xref:configuring-registry-storage-vsphere[Configuring the registry for vSphere]
...
* For more information on allowing pods in a project to reference images in another project, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/images/#images-allow-pods-to-reference-images-across-projects_using-image-pull-secrets[Allowing pods to reference images across projects].
* A `kubeadmin` can access the registry until deleted. See
link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/authentication_and_authorization/#[Removing the kubeadmin user] for
more information.
* For more information on configuring an identity provider, see
link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/authentication_and_authorization/#[Understanding identity provider configuration].
