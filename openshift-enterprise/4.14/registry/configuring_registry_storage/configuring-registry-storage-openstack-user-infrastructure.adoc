...
//# includes=_attributes/common-attributes,modules/registry-configuring-registry-storage-swift-trust,modules/registry-operator-config-resources-secret-openstack,modules/registry-configuring-storage-openstack-user-infra,modules/registry-operator-configuration-resource-overview-openstack-swift
