...
//# includes=_attributes/common-attributes,snippets/technology-preview,modules/cli-krew-install-plugin,modules/cli-krew-update-plugin,modules/cli-krew-remove-plugin
