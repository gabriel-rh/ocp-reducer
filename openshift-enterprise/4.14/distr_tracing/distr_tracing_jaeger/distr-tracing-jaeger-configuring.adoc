...
//# includes=_attributes/common-attributes,modules/distr-tracing-deploy-default,modules/distr-tracing-deploy-production-es,modules/distr-tracing-deploy-streaming,modules/distr-tracing-accessing-jaeger-console,modules/distr-tracing-deployment-best-practices,modules/distr-tracing-config-default,modules/distr-tracing-config-jaeger-collector,modules/distr-tracing-config-sampling,modules/distr-tracing-config-storage,modules/snippets/technology-preview,modules/distr-tracing-config-query,modules/distr-tracing-config-ingester,modules/distr-tracing-sidecar-automatic,modules/distr-tracing-sidecar-manual
