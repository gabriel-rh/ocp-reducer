...
//# includes=_attributes/common-attributes,modules/nodes-pods-configuring-restart,modules/nodes-pods-configuring-bandwidth,modules/nodes-pods-pod-disruption-about,modules/nodes-pods-pod-disruption-configuring,modules/pod-disruption-eviction-policy,modules/nodes-pods-configuring-pod-critical,modules/nodes-pods-configuring-reducing
