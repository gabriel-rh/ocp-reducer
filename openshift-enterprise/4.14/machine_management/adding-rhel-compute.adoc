...
//# includes=_attributes/common-attributes,modules/rhel-compute-overview,modules/rhel-compute-requirements,modules/csr-management,modules/rhel-images-aws,modules/rhel-preparing-playbook-machine,modules/rhel-preparing-node,modules/rhel-attaching-instance-aws,modules/rhel-worker-tag,modules/rhel-adding-node,modules/installation-approve-csrs,modules/rhel-ansible-parameters,modules/rhel-removing-rhcos
