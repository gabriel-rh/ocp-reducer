...
//# includes=_attributes/common-attributes,modules/machine-user-infra-machines-iso,modules/machine-user-infra-machines-pxe,modules/installation-approve-csrs
