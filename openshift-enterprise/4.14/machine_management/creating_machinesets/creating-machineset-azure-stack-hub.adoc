...
//# includes=_attributes/common-attributes,modules/machine-user-provisioned-limitations,modules/machineset-yaml-azure-stack-hub,modules/machineset-creating,modules/machineset-azure-boot-diagnostics,modules/machineset-customer-managed-encryption-azure
