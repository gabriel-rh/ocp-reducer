...
//# includes=_attributes/common-attributes,modules/insights-operator-configuring-sca,modules/insights-operator-disabling-sca,modules/insights-operator-enabling-sca
