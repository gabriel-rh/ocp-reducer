...
//# includes=_attributes/common-attributes,modules/determining-where-installation-issues-occur,modules/upi-installation-considerations,modules/checking-load-balancer-configuration,modules/specifying-openshift-installer-log-levels,modules/troubleshooting-openshift-install-command-issues,modules/monitoring-installation-progress,modules/gathering-bootstrap-diagnostic-data,modules/investigating-master-node-installation-issues,modules/investigating-etcd-installation-issues,modules/investigating-kubelet-api-installation-issues,modules/investigating-worker-node-installation-issues,modules/querying-operator-status-after-installation,modules/installation-bootstrap-gather
