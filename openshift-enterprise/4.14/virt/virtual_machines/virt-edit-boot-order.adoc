...
//# includes=_attributes/common-attributes,modules/virt-add-boot-order-web,modules/virt-edit-boot-order-web,modules/virt-edit-boot-order-yaml-web,modules/virt-remove-boot-order-item-web
