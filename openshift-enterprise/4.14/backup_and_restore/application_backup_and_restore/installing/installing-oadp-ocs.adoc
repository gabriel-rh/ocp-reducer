...
//# includes=_attributes/common-attributes,snippets/oadp-mtc-operator,snippets/technology-preview,modules/oadp-about-backup-snapshot-locations-secrets,modules/oadp-creating-default-secret,modules/oadp-secrets-for-different-credentials,modules/oadp-setting-resource-limits-and-requests,modules/oadp-self-signed-certificate,modules/oadp-installing-dpa,modules/oadp-creating-object-bucket-claim,modules/snippets/snip-noobaa-and-mcg,modules/oadp-enabling-csi-dpa
