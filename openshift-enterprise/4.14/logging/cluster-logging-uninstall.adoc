...
//# includes=_attributes/common-attributes,modules/cluster-logging-uninstall,modules/olm-deleting-operators-from-a-cluster-using-web-console,modules/olm-deleting-operators-from-a-cluster-using-cli
