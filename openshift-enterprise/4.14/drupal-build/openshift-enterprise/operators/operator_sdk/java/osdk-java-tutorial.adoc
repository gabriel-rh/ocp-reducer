...
[NOTE]
====
This tutorial goes into greater detail than xref:osdk-java-quickstart[Getting started with Operator SDK for Java-based Operators].
====
...
include::../../includes/osdk-java-create-api-controller.adoc[leveloffset=+1]
include::../../includes/osdk-java-define-api.adoc[leveloffset=+2]
include::../../includes/osdk-java-generate-crd.adoc[leveloffset=+2]
include::../../includes/osdk-java-create-cr.adoc[leveloffset=+2]

include::../../includes/osdk-java-implement-controller.adoc[leveloffset=+1]

The next subsections explain how the controller in the example implementation watches resources and how the reconcile loop is triggered. You can skip these subsections to go directly to xref:osdk-run-operator_osdk-java-tutorial[Running the Operator].

include::../../includes/osdk-java-controller-reconcile-loop.adoc[leveloffset=+2]
include::../../includes/osdk-java-controller-labels-memcached.adoc[leveloffset=+2]
include::../../includes/osdk-java-controller-memcached-deployment.adoc[leveloffset=+2]
...
ifndef::openshift-dedicated,openshift-rosa[]
include::../../includes/osdk-run-locally.adoc[leveloffset=+2]
include::../../includes/osdk-run-deployment.adoc[leveloffset=+2]
endif::openshift-dedicated,openshift-rosa[]
