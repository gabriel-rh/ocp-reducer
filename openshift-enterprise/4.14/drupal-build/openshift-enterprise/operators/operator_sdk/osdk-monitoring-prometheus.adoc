...
include::../includes/osdk-monitoring-prometheus-operator-support.adoc[leveloffset=+1]
include::../includes/osdk-monitoring-custom-metrics.adoc[leveloffset=+1]
include::../includes/osdk-ansible-metrics.adoc[leveloffset=+1]
