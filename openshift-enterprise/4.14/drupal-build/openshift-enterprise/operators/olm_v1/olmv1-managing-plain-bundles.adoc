...
* xref:olmv1-rukpak[RukPak component and packaging format]
...
include::../includes/olmv1-building-plain-image.adoc[leveloffset=+1]
include::../includes/olmv1-creating-fbc.adoc[leveloffset=+1]
include::../includes/olmv1-adding-plain-to-fbc.adoc[leveloffset=+1]
include::../includes/olmv1-publishing-fbc.adoc[leveloffset=+1]