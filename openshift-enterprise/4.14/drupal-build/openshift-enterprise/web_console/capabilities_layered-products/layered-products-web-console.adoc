...
//pipelines
include::../includes/pipelines-web-console.adoc[leveloffset=+1]
...
//serverless
include::../includes/serverless-web-console.adoc[leveloffset=+1]
...
//RHDH
include::../includes/rhdh-web-console.adoc[leveloffset=+1]
