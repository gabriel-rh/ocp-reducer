...
include::../includes/spo-installing.adoc[leveloffset=+1]

include::../includes/spo-installing-cli.adoc[leveloffset=+1]

include::../includes/spo-logging-verbosity.adoc[leveloffset=+1]