...
include::includes/configuring-default-seccomp-profile.adoc[leveloffset=+1]
...
include::includes/creating-custom-seccomp-profile.adoc[leveloffset=+2]
include::includes/setting-custom-seccomp-profile.adoc[leveloffset=+2]
include::includes/applying-custom-seccomp-profile.adoc[leveloffset=+2]
...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/postinstallation_configuration/#machine-configuration-tasks[Postinstallation machine configuration tasks]
