...
include::includes/tls-profiles-understanding.adoc[leveloffset=+1]

// Viewing TLS security profile details
include::includes/tls-profiles-view-details.adoc[leveloffset=+1]

// Configuring for ingress
include::includes/tls-profiles-ingress-configuring.adoc[leveloffset=+1]

// Configuring for the control plane
include::includes/tls-profiles-kubernetes-configuring.adoc[leveloffset=+1]

// Configuring for kubelet
include::includes/tls-profiles-kubelet-configuring.adoc[leveloffset=+1]
