...
// About ACME issuers
include::../includes/cert-manager-acme-about.adoc[leveloffset=+1]

// Supported ACME challenges types
include::../includes/cert-manager-acme-challenges-types.adoc[leveloffset=+2]

// Supported DNS-01 providers
include::../includes/cert-manager-acme-dns-providers.adoc[leveloffset=+2]

// Configuring an ACME issuer to solve HTTP01 challenges
include::../includes/cert-manager-acme-http01.adoc[leveloffset=+1]

// Configuring an ACME issuer to solve DNS01 challenges by using explicit credentials on AWS
include::../includes/cert-manager-acme-dns01-explicit-aws.adoc[leveloffset=+1]

//Configuring an ACME issuer to solve DNS01 challenges by using ambient credentials on AWS
include::../includes/cert-manager-acme-dns01-ambient-aws.adoc[leveloffset=+1]

// Configuring an ACME issuer to solve DNS01 challenges by using explicit credentials on GCP
include::../includes/cert-manager-acme-dns01-explicit-gcp.adoc[leveloffset=+1]

// Configuring an ACME issuer to solve DNS01 challenges by using ambient credentials on GCP
include::../includes/cert-manager-acme-dns01-ambient-gcp.adoc[leveloffset=+1]

// Configuring an ACME issuer to solve DNS01 challenges by using explicit credentials on Microsoft Azure
include::../includes/cert-manager-acme-dns01-explicit-azure.adoc[leveloffset=+1]
