...
include::../includes/cert-manager-about.adoc[leveloffset=+1]

// Supported issuer types
include::../includes/cert-manager-issuer-types.adoc[leveloffset=+1]

// Certificate request methods
include::../includes/cert-manager-request-methods.adoc[leveloffset=+1]
