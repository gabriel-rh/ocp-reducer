...
include::../includes/security-container-content-inside.adoc[leveloffset=+1]

// Red Hat Universal Base Images
include::../includes/security-container-content-universal.adoc[leveloffset=+1]

// Container content scanning
include::../includes/security-container-content-scanning.adoc[leveloffset=+1]

// Integrating external scanning tools with OpenShift
include::../includes/security-container-content-external-scanning.adoc[leveloffset=+1]
