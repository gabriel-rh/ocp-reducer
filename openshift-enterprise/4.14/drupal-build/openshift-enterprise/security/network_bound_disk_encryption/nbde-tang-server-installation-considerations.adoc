...
include::../includes/nbde-installation-scenarios.adoc[leveloffset=+1]
...
include::../includes/nbde-compute-requirements.adoc[leveloffset=+2]

include::../includes/nbde-automatic-start-at-boot.adoc[leveloffset=+2]

include::../includes/nbde-http-versus-https.adoc[leveloffset=+2]
