...
include::../../includes/persistent-storage-hostpath-about.adoc[leveloffset=+1]
include::../../includes/persistent-storage-hostpath-static-provisioning.adoc[leveloffset=+1]
include::../../includes/persistent-storage-hostpath-pod.adoc[leveloffset=+1]
