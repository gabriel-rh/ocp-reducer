...
include::../includes/persistent-storage-fibre-provisioning.adoc[leveloffset=+1]

include::../includes/persistent-storage-fibre-disk-quotas.adoc[leveloffset=+2]

include::../includes/persistent-storage-fibre-volume-security.adoc[leveloffset=+2]
