...
:provider: AWS
include::../includes/storage-persistent-storage-volume-format.adoc[leveloffset=+1]

include::../includes/storage-persistent-storage-aws-maximum-volumes.adoc[leveloffset=+1]
...
include::../includes/storage-persistent-storage-volume-encrypt-with-kms-key.adoc[leveloffset=+1]
