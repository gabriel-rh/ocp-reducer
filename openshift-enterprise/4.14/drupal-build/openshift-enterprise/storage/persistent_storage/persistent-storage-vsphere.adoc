...
== Prerequisites
* An {product-title} cluster installed on a VMware vSphere version that meets the requirements for the components that you use. See link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/installing/#installing-a-cluster-1[Installing a cluster on vSphere] for information about vSphere version support.

You can use either of the following procedures to dynamically provision these volumes using the default storage class.

include::../includes/persistent-storage-vsphere-dynamic-provisioning.adoc[leveloffset=+2]

include::../includes/persistent-storage-vsphere-dynamic-provisioning-cli.adoc[leveloffset=+2]

include::../includes/persistent-storage-vsphere-static-provisioning.adoc[leveloffset=+1]

include::../includes/persistent-storage-vsphere-formatting.adoc[leveloffset=+2]
