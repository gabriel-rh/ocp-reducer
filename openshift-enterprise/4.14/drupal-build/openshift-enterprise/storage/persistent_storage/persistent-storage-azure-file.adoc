...
include::../includes/storage-persistent-storage-azure-file.adoc[leveloffset=+1]

include::../includes/storage-persistent-storage-azure-file-pod.adoc[leveloffset=+1]
