...
include::../includes/persistent-storage-cinder-provisioning.adoc[leveloffset=+1]

include::../includes/persistent-storage-cinder-creating-pv.adoc[leveloffset=+2]

include::../includes/persistent-storage-cinder-pv-format.adoc[leveloffset=+2]

include::../includes/persistent-storage-cinder-volume-security.adoc[leveloffset=+2]
