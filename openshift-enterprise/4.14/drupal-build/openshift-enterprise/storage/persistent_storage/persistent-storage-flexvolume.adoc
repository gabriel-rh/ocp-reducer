...
include::../includes/persistent-storage-flexvolume-drivers.adoc[leveloffset=+1]

include::../includes/persistent-storage-flexvolume-driver-example.adoc[leveloffset=+1]

include::../includes/persistent-storage-flexvolume-installing.adoc[leveloffset=+1]

include::../includes/persistent-storage-flexvolume-consuming.adoc[leveloffset=+1]
