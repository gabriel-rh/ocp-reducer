...
include::../includes/persistent-storage-csi-gcp-file-install.adoc[leveloffset=+1]
...
include::../includes/persistent-storage-csi-google-cloud-file-create-sc.adoc[leveloffset=+1]

include::../includes/persistent-storage-csi-google-cloud-file-delete-instances.adoc[leveloffset=+1]
