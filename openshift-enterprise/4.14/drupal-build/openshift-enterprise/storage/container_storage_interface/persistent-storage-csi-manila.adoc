...
include::../includes/persistent-storage-csi-manila-limitations.adoc[leveloffset=+1]

include::../includes/persistent-storage-csi-manila-dynamic-provisioning.adoc[leveloffset=+1]
