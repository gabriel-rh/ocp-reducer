...
For more information about upgrading Operators, refer to the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/operators/#updating-installed-operators[Operator Lifecycle Manager] documentation.
endif::[]
