...
include::../includes/ossm-configuring-the-threescale-wasm-auth-module.adoc[leveloffset=+1]
...
include::../includes/ossm-threescale-applying-external-service-entry-objects.adoc[leveloffset=+1]

include::../includes/ossm-threescale-webassembly-module-configuration.adoc[leveloffset=+1]

include::../includes/ossm-threescale-configuring-the-threescale-webassembly-module.adoc[leveloffset=+2]

include::../includes/ossm-threescale-webassembly-module-api-object.adoc[leveloffset=+2]

include::../includes/ossm-threescale-webassembly-module-system-object.adoc[leveloffset=+2]

include::../includes/ossm-threescale-webassembly-module-upstream-object.adoc[leveloffset=+2]

include::../includes/ossm-threescale-webassembly-module-backend-object.adoc[leveloffset=+2]

include::../includes/ossm-threescale-webassembly-module-services-object.adoc[leveloffset=+2]

include::../includes/ossm-threescale-webassembly-module-credentials-object.adoc[leveloffset=+2]

include::../includes/ossm-threescale-webassembly-module-lookup-queries.adoc[leveloffset=+2]

include::../includes/ossm-threescale-webassembly-module-source-object.adoc[leveloffset=+2]

include::../includes/ossm-threescale-webassembly-module-operations-object.adoc[leveloffset=+2]

include::../includes/ossm-threescale-webassembly-module-mapping-rules-object.adoc[leveloffset=+2]

include::../includes/ossm-threescale-webassembly-module-mapping-rule-object.adoc[leveloffset=+2]

include::../includes/ossm-threescale-webassembly-module-examples-for-credentials-use-cases.adoc[leveloffset=+1]

include::../includes/ossm-threescale-webassembly-module-minimal-working-configuration.adoc[leveloffset=+1]