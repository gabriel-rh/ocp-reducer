...
include::includes/api-support-tiers.adoc[leveloffset=+1]

include::includes/api-support-tiers-mapping.adoc[leveloffset=+1]

include::includes/api-support-deprecation-policy.adoc[leveloffset=+1]
