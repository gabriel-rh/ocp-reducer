...
include::includes/otel-migrating-from-jaeger-with-sidecars.adoc[leveloffset=+1]

include::includes/otel-migrating-from-jaeger-without-sidecars.adoc[leveloffset=+1]
