...
+
include::./network-observability-clusterrole-reader.adoc[]
include::./network-observability-clusterrole-writer.adoc[]
include::./network-observability-clusterrolebinding.adoc[]