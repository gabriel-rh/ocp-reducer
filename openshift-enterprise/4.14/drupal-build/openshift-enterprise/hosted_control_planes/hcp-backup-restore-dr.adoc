...
include::includes/hosted-cluster-etcd-status.adoc[leveloffset=+2]
include::includes/hosted-cluster-single-node-recovery.adoc[leveloffset=+2]
include::includes/hosted-cluster-etcd-quorum-loss-recovery.adoc[leveloffset=+2]
...
include::includes/backup-etcd-hosted-cluster.adoc[leveloffset=+2]

// Restoring an etcd snapshot on a hosted cluster
include::includes/restoring-etcd-snapshot-hosted-cluster.adoc[leveloffset=+2]
...
include::includes/dr-hosted-cluster-within-aws-region-backup.adoc[leveloffset=+2]

// Restoring the hosted cluster
include::includes/dr-hosted-cluster-within-aws-region-restore.adoc[leveloffset=+2]

// Deleting the hosted cluster
include::includes/dr-hosted-cluster-within-aws-region-delete.adoc[leveloffset=+2]

//Helper script
include::includes/dr-hosted-cluster-within-aws-region-script.adoc[leveloffset=+2]