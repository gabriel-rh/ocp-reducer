...
[source,yaml]
----
include::includes/Containerfile[]
----
+
...
include::includes/coreos-layering-configuring.adoc[leveloffset=+1]

.Additional resources
xref:coreos-layering-updating_coreos-layering[Updating with a {op-system} custom layered image]

include::includes/coreos-layering-removing.adoc[leveloffset=+1]
include::includes/coreos-layering-updating.adoc[leveloffset=+1]
