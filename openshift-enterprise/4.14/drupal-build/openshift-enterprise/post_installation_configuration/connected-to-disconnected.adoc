...
include::includes/connected-to-disconnected-prepare-mirror.adoc[leveloffset=+1]
include::includes/connected-to-disconnected-mirror-images.adoc[leveloffset=+1]
...
include::includes/connected-to-disconnected-config-registry.adoc[leveloffset=+1]
include::includes/connected-to-disconnected-verify.adoc[leveloffset=+1]
include::includes/connected-to-disconnected-disconnect.adoc[leveloffset=+1]

[NOTE]
====
The Insights Operator is degraded when the cluster loses its Internet connection. You can avoid this problem by temporarily link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/support/#opting-out-of-remote-health-reporting[disabling the Insights Operator] until you can restore it.
====

include::includes/connected-to-disconnected-restore-insights.adoc[leveloffset=+1]
include::includes/connected-to-disconnected-restore.adoc[leveloffset=+1]
