...
include::../includes/configuring-egress-proxy.adoc[leveloffset=+1]

[role="_additional-resources"]
== Additional resources

* xref:certificate-injection-using-operators_configuring-a-custom-pki[Certificate injection using Operators]