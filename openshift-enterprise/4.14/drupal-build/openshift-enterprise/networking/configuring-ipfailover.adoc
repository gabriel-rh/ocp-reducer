...
include::includes/nw-ipfailover-environment-variables.adoc[leveloffset=+1]

include::includes/nw-ipfailover-configuration.adoc[leveloffset=+1]

include::includes/nw-ipfailover-virtual-ip-addresses-concept.adoc[leveloffset=+1]

include::includes/nw-ipfailover-configuring-check-notify-scripts.adoc[leveloffset=+1]

include::includes/nw-ipfailover-configuring-vrrp-preemption.adoc[leveloffset=+1]

//Omitted the following procedure for now. We can update it to use `oc debug` if needed.
//include::includes/nw-ipfailover-configuring-keepalived-multicast.adoc[leveloffset=+1]

include::includes/nw-ipfailover-vrrp-ip-offset.adoc[leveloffset=+1]

include::includes/nw-ipfailover-configuring-more-than-254.adoc[leveloffset=+1]

include::includes/nw-ipfailover-cluster-ha-ingress.adoc[leveloffset=+1]

include::includes/nw-ipfailover-remove.adoc[leveloffset=+1]
