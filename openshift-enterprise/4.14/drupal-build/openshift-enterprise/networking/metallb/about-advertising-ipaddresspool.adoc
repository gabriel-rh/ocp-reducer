...
include::../includes/nw-metallb-bgpadvertisement-cr.adoc[leveloffset=+1]

// Configure MetalLB with a BGP advertisement
include::../includes/nw-metallb-configure-bgp-advertisement.adoc[leveloffset=+1]

// Advertise MetalLB with a BGP advertisement
include::../includes/nw-metallb-advertise-address-pool-with-bgp.adoc[leveloffset=+2]

// Configure MetalLB with a BGP advertisement
include::../includes/nw-metallb-configure-bgp-advertisement-advanced.adoc[leveloffset=+1]

// Advertise MetalLB with a BGP advertisement
include::../includes/nw-metallb-advertise-address-pool-with-bgp-advanced.adoc[leveloffset=+2]

// Advertise IP address pools from a subset of nodes
include::../includes/nw-metallb-advertise-ip-pools-from-node-subset.adoc[leveloffset=+1]

// L2 advertisement custom resource
include::../includes/nw-metallb-l2padvertisement-cr.adoc[leveloffset=+1]

// Configure MetalLB with a L2 advertisement
include::../includes/nw-metallb-configure-l2-advertisement.adoc[leveloffset=+1]

// Configure MetalLB with a L2 advertisement using label
include::../includes/nw-metallb-configure-l2-advertisement-label.adoc[leveloffset=+1]

// Configure MetalLB with a L2 advertisement using interface
include::../includes/nw-metallb-configure-l2-advertisement-interface.adoc[leveloffset=+1]

[role="_additional-resources"]
[id="additional-resources_about-advertiseipaddress"]
== Additional resources

* xref:metallb-configure-community-alias[Configuring a community alias].
