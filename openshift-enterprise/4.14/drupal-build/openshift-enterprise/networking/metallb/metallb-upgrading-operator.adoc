...
include::../includes/olm-deleting-metallb-operators-from-a-cluster-using-web-console.adoc[leveloffset=+1]

//Delete metallb using cli
include::../includes/olm-deleting-metallb-operators-from-a-cluster-using-cli.adoc[leveloffset=+1]

//Delete targetNamespace
include::../includes/olm-updating-metallb-operatorgroup.adoc[leveloffset=+1]

//Upgrade the MetalLB
include::../includes/nw-metalLB-basic-upgrade-operator.adoc[leveloffset=+1]
...
* xref:metallb-operator-install[Installing the MetalLB Operator]
