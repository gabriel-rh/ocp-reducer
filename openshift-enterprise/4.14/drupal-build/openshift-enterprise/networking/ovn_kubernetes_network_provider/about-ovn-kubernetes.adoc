...
include::../includes/nw-ovn-kubernetes-features.adoc[leveloffset=+1]

include::../includes/nw-ovn-kubernetes-matrix.adoc[leveloffset=+1]
// This is a moving target; what is included isn't valid for 4.6
//include::../includes/nw-ovn-kubernetes-metrics.adoc[leveloffset=+1]

include::../includes/nw-ovn-kuberentes-limitations.adoc[leveloffset=+1]

include::../includes/nw-ovn-kubernetes-session-affinity.adoc[leveloffset=+1]
...
* xref:logging-network-policy[Logging network policy events]
* xref:nw-ovn-kubernetes-enabling-multicast[Enabling multicast for a project]
* xref:configuring-ipsec-ovn[Configuring IPsec encryption]
