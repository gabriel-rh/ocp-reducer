...
include::../includes/nw-network-flows-object.adoc[leveloffset=+1]

include::../includes/nw-network-flows-create.adoc[leveloffset=+1]

include::../includes/nw-network-flows-delete.adoc[leveloffset=+1]
