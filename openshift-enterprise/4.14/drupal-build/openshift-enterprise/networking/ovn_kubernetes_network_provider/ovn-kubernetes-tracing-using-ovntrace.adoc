...
include::../includes/nw-ovn-kubernetes-install-ovnkube-trace-local.adoc[leveloffset=+1]

include::../includes/nw-ovn-kubernetes-running-ovnkube-trace.adoc[leveloffset=+1]
