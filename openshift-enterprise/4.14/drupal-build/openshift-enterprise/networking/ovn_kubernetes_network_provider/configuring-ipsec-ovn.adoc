...
* You have decreased the size of the cluster MTU by `46` bytes to allow for the additional overhead of the IPsec ESP header. For more information on resizing the MTU that your cluster uses, see xref:changing-cluster-network-mtu[Changing the MTU for the cluster network].

include::../includes/nw-own-ipsec-required-ports.adoc[leveloffset=+1]
...
include::../includes/nw-ovn-ipsec-traffic.adoc[leveloffset=+2]
include::../includes/nw-ovn-ipsec-encryption.adoc[leveloffset=+2]
include::../includes/nw-ovn-ipsec-certificates.adoc[leveloffset=+2]
include::../includes/nw-ovn-ipsec-enable.adoc[leveloffset=+2]
include::../includes/nw-ovn-ipsec-verification.adoc[leveloffset=+2]
include::../includes/nw-ovn-ipsec-disable.adoc[leveloffset=+2]
...
include::../includes/nw-ovn-ipsec-north-south-enable.adoc[leveloffset=+2]

[id="{context}_additional-resources"]
== Additional resources

* xref:about-ovn-kubernetes[About the OVN-Kubernetes Container Network Interface (CNI) network plugin]
* xref:changing-cluster-network-mtu[Changing the MTU for the cluster network]
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/installing/#installation-special-config-butane-install_installing-customizing[Installing Butane]
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/api_reference/#network-operator-openshift-io-v1[Network [operator.openshift.io/v1]] API
