...
When expanding the cluster network address range, your cluster must use the xref:about-ovn-kubernetes[OVN-Kubernetes network plugin]. Other network plugins are not supported.
...
include::includes/nw-cluster-network-range-edit.adoc[leveloffset=+1]

[role="_additional-resources"]
[id="configuring-cluster-network-range-additional-resources"]
== Additional resources

* xref:about-ovn-kubernetes[About the OVN-Kubernetes network plugin]
