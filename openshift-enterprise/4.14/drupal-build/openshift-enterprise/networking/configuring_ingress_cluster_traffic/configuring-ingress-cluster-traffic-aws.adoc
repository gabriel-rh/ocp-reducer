...
include::../includes/nw-configuring-elb-timeouts-aws-classic.adoc[leveloffset=+1]

include::../includes/nw-configuring-route-timeouts.adoc[leveloffset=+2]

include::../includes/nw-configuring-clb-timeouts.adoc[leveloffset=+2]

include::../includes/nw-configuring-ingress-cluster-traffic-aws-networking-load-balancer.adoc[leveloffset=+1]

include::../includes/nw-aws-switching-clb-with-nlb.adoc[leveloffset=+2]

include::../includes/nw-aws-switching-nlb-with-clb.adoc[leveloffset=+2]

include::../includes/nw-aws-replacing-clb-with-nlb.adoc[leveloffset=+2]

include::../includes/nw-aws-nlb-existing-cluster.adoc[leveloffset=+2]

[IMPORTANT]
====
Before you can configure an Ingress Controller NLB on a new AWS cluster, you must complete the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/installing/#installation-initializing_installing-aws-network-customizations[Creating the installation configuration file] procedure.
====

include::../includes/nw-aws-nlb-new-cluster.adoc[leveloffset=+2]
