...
By default, each route uses the default domain of the cluster. However, routes can be configured to use the domain of the router instead. For more information, see xref:nw-ingress-sharding-route-configuration_ingress-sharding[Creating a route for Ingress Controller Sharding].

include::includes/nw-ingress-sharding.adoc[leveloffset=+1]

include::includes/nw-ingress-sharding-default.adoc[leveloffset=+2]

include::includes/nw-ingress-sharding-dns.adoc[leveloffset=+2]

include::includes/nw-ingress-sharding-route-labels.adoc[leveloffset=+2]

include::includes/nw-ingress-sharding-namespace-labels.adoc[leveloffset=+2]
...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/scalability_and_performance/#baseline-router-performance_routing-optimization[Baseline Ingress Controller (router) performance]
