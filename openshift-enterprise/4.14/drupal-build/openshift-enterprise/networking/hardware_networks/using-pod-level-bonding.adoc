...
For guidance on tasks such as creating a SR-IOV network, network policies, network attachment definitions and pods, see  xref:configuring-sriov-device[Configuring an SR-IOV network device].

include::../includes/nw-sriov-cfg-bond-interface-with-virtual-functions.adoc[leveloffset=+1]