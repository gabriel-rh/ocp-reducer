...
include::../includes/nw-sriov-supported-platforms.adoc[leveloffset=+2]
include::../includes/nw-sriov-supported-devices.adoc[leveloffset=+2]
include::../includes/nw-sriov-device-discovery.adoc[leveloffset=+2]
include::../includes/nw-sriov-example-vf-function-in-pod.adoc[leveloffset=+2]
include::../includes/nw-sriov-app-netutil.adoc[leveloffset=+2]
include::../includes/nw-sriov-huge-pages.adoc[leveloffset=+2]

[role="_additional-resources"]
[id="configure-multi-networks-additional-resources"]
== Additional resources

* xref:configuring-multi-network-policy[Configuring multi-network policy]

[id="about-sriov-next-steps"]
== Next steps

* xref:installing-sriov-operator[Installing the SR-IOV Network Operator]
...
* If you use {VirtProductName}: link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/virtualization/#virt-connecting-vm-to-sriov[Connecting a virtual machine to an SR-IOV network]
