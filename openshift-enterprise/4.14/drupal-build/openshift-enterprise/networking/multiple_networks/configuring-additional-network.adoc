...
* xref:nw-multus-bridge-object_configuring-additional-network[Bridge]
* xref:nw-multus-host-device-object_configuring-additional-network[Host device]
* xref:nw-multus-vlan-object_configuring-additional-network[VLAN]
* xref:nw-multus-ipvlan-object_configuring-additional-network[IPVLAN]
* xref:nw-multus-macvlan-object_configuring-additional-network[MACVLAN]
* xref:nw-multus-tap-object_configuring-additional-network[TAP]
* xref:configuration-ovnk-additional-networks_configuring-additional-network[OVN-Kubernetes]
...
include::../includes/nw-multus-bridge-object.adoc[leveloffset=+2]
include::../includes/nw-multus-host-device-object.adoc[leveloffset=+2]
include::../includes/nw-multus-vlan-object.adoc[leveloffset=+2]
include::../includes/nw-multus-ipvlan-object.adoc[leveloffset=+2]
include::../includes/nw-multus-macvlan-object.adoc[leveloffset=+2]
include::../includes/nw-multus-tap-object.adoc[leveloffset=+2]

[role="_additional-resources"]
.Additional resources

* For more information about enabling an SELinux boolean on a node, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/nodes/#nodes-nodes-working-setting-booleans_nodes-nodes-managing[Setting SELinux booleans]

// Set of includes pertains to OVN-Kubernetes additional network
include::../includes/configuring-ovnk-additional-networks.adoc[leveloffset=+2]
include::../includes/configuration-ovnk-network-plugin-json-object.adoc[leveloffset=+3]
include::../includes/configuration-ovnk-multi-network-policy.adoc[leveloffset=+3]

//include::../includes/configuring-layer-three-routed-topology.adoc[leveloffset=+3]
include::../includes/configuring-layer-two-switched-topology.adoc[leveloffset=+3]

[id="{context}_ovn-kubernetes-configuration-for-a-localnet-topology"]
==== Configuration for a localnet topology

include::../includes/configuring-localnet-switched-topology.adoc[tag=localnet-intro]
...
- The NMState Operator is installed. For more information, see xref:k8s-nmstate-about-the-k8s-nmstate-operator[About the Kubernetes NMState Operator].

[id="{context}_configuration-additional-network-interface"]
===== Configuration for an OVN-Kubernetes additional network mapping

include::../includes/configuring-localnet-switched-topology.adoc[tag=localnet-content]
include::../includes/configuring-pods-secondary-network.adoc[leveloffset=+3]
include::../includes/configuring-pods-static-ip.adoc[leveloffset=+3]
// end OVN-Kubernetes includes

include::../includes/nw-multus-ipam-object.adoc[leveloffset=+1]

include::../includes/nw-multus-creating-whereabouts-reconciler-daemon-set.adoc[leveloffset=+2]

include::../includes/nw-multus-configuring-whereabouts-ip-reconciler-schedule.adoc[leveloffset=+2]
...
include::../includes/nw-multus-create-network.adoc[leveloffset=+1]

include::../includes/nw-multus-create-network-apply.adoc[leveloffset=+1]

include::../includes/nw-about-configuring-master-interface-container.adoc[leveloffset=+1]

include::../includes/nw-multus-create-multiple-vlans-sriov.adoc[leveloffset=+2]

include::../includes/nw-multus-create-master-interface-bridge-cni.adoc[leveloffset=+2]
