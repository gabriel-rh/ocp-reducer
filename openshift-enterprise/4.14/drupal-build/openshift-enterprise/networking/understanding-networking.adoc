...
include::includes/nw-ne-openshift-dns.adoc[leveloffset=+1]
include::includes/nw-ne-openshift-ingress.adoc[leveloffset=+1]
include::includes/nw-ne-comparing-ingress-route.adoc[leveloffset=+2]
include::includes/nw-networking-glossary-terms.adoc[leveloffset=+1]
