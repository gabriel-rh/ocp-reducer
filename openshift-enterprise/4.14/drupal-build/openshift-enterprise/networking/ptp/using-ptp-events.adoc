...
include::../includes/cnf-about-ptp-and-clock-synchronization.adoc[leveloffset=+1]

include::../includes/cnf-about-ptp-fast-event-notifications-framework.adoc[leveloffset=+1]

include::../includes/cnf-configuring-the-ptp-fast-event-publisher.adoc[leveloffset=+1]
...
include::../includes/cnf-migrating-from-amqp-to-http-transport.adoc[leveloffset=+1]

include::../includes/cnf-installing-amq-interconnect-messaging-bus.adoc[leveloffset=+1]
...
include::../includes/cnf-fast-event-notifications-api-refererence.adoc[leveloffset=+2]

include::../includes/cnf-monitoring-fast-events-metrics.adoc[leveloffset=+1]
...
include::../includes/nw-ptp-operator-metrics-reference.adoc[leveloffset=+1]
