...
include::../includes/nw-ptp-introduction.adoc[leveloffset=+1]

[IMPORTANT]
====
Before enabling PTP, ensure that NTP is disabled for the required nodes. You can disable the chrony time service (`chronyd`) using a `MachineConfig` custom resource. For more information, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/postinstallation_configuration/#cnf-disable-chronyd_post-install-machine-configuration-tasks[Disabling chrony time service].
====

include::../includes/ptp-dual-nics.adoc[leveloffset=+1]

include::../includes/ptp-linuxptp-introduction.adoc[leveloffset=+1]

include::../includes/ptp-overview-of-gnss-grandmaster-clock.adoc[leveloffset=+1]
