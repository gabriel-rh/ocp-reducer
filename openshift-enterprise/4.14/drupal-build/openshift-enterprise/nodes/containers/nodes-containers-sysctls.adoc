...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/scalability_and_performance/#using-node-tuning-operator[Node Tuning Operator]
...
include::../includes/nodes-containers-sysctls-about.adoc[leveloffset=+1]

include::../includes/nodes-namespaced-nodelevel-sysctls.adoc[leveloffset=+1]

include::../includes/nodes-safe-sysctls-list.adoc[leveloffset=+1]

include::../includes/update-network-sysctl-allowlist.adoc[leveloffset=+1]
...
include::../includes/nodes-containers-start-pod-safe-sysctls.adoc[leveloffset=+1]

include::../includes/nodes-containers-sysctls-setting.adoc[leveloffset=+1]

include::../includes/nodes-containers-sysctls-unsafe.adoc[leveloffset=+1]

[role="_additional-resources"]
[id="additional-resources_nodes-containers-sysctls"]
== Additional resources

* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/networking/#nw-configuring-tuning-cni_configure-syscontrols-interface-tuning-cni[Configuring system controls by using the tuning CNI]