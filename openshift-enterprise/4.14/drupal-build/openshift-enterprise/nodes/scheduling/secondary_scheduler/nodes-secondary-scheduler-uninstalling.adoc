...
// Uninstalling the {secondary-scheduler-operator}
include::../../includes/nodes-secondary-scheduler-uninstall-console.adoc[leveloffset=+1]

// Removing {secondary-scheduler-operator} resources
include::../../includes/nodes-secondary-scheduler-remove-resources-console.adoc[leveloffset=+1]
