...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/installing/#ocp-installation-overview[OpenShift Container Platform installation overview]
