...
include::../includes/nodes-cluster-resource-configure-about.adoc[leveloffset=+1]

ifdef::openshift-origin,openshift-online,openshift-webscale,openshift-enterprise[]
[role="_additional-resources"]
.Additional resources
* xref:nodes-cluster-overcommit-reserving-memory_nodes-cluster-overcommit[Understanding compute resources and containers]
endif::[]

include::../includes/nodes-cluster-resource-configure-jdk.adoc[leveloffset=+1]

include::../includes/nodes-cluster-resource-configure-request-limit.adoc[leveloffset=+1]

include::../includes/nodes-cluster-resource-configure-oom.adoc[leveloffset=+1]

include::../includes/nodes-cluster-resource-configure-evicted.adoc[leveloffset=+1]
