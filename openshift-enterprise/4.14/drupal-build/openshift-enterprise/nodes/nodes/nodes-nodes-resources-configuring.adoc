...
include::../includes/nodes-nodes-resources-configuring-about.adoc[leveloffset=+1]

include::../includes/nodes-nodes-resources-configuring-auto.adoc[leveloffset=+1]

include::../includes/nodes-nodes-resources-configuring-setting.adoc[leveloffset=+1]
