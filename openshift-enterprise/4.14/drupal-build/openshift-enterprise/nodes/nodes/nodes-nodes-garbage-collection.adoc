...
include::../includes/nodes-nodes-garbage-collection-containers.adoc[leveloffset=+1]

include::../includes/nodes-nodes-garbage-collection-images.adoc[leveloffset=+1]

include::../includes/nodes-nodes-garbage-collection-configuring.adoc[leveloffset=+1]
