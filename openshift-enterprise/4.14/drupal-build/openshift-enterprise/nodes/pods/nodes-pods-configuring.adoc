...
ifndef::openshift-rosa,openshift-dedicated[]
* xref:nodes-cluster-enabling[Enabling features using feature gates]
...
include::../includes/nodes-pods-configuring-pod-critical.adoc[leveloffset=+1]

include::../includes/nodes-pods-configuring-reducing.adoc[leveloffset=+1]
endif::openshift-rosa,openshift-dedicated[]
