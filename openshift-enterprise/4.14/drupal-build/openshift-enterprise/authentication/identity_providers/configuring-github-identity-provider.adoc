...
include::../includes/identity-provider-github-about.adoc[leveloffset=+1]

include::../includes/identity-provider-registering-github.adoc[leveloffset=+1]
...
include::../includes/identity-provider-github-CR.adoc[leveloffset=+1]
