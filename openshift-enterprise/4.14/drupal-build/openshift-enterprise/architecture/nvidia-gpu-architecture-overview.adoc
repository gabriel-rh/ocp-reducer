...
include::includes/nvidia-gpu-enablement.adoc[leveloffset=+1]

include::includes/nvidia-gpu-bare-metal.adoc[leveloffset=+2]
...
include::includes/nvidia-gpu-virtualization.adoc[leveloffset=+2]
[role="_additional-resources"]
.Additional resources
...
include::includes/nvidia-gpu-vsphere.adoc[leveloffset=+2]
[role="_additional-resources"]
.Additional resources
...
include::includes/nvidia-gpu-kvm.adoc[leveloffset=+2]
[role="_additional-resources"]
.Additional resources
...
include::includes/nvidia-gpu-csps.adoc[leveloffset=+2]
[role="_additional-resources"]
.Additional resources
...
include::includes/nvidia-gpu-red-hat-device-edge.adoc[leveloffset=+2]
[role="_additional-resources"]
.Additional resources
...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/specialized_hardware_and_driver_enablement/#node-feature-discovery-operator-1[Node Feature Discovery Operator]
