...
include::../../includes/oadp-cleaning-up-after-data-mover-snapshots.adoc[leveloffset=+1]
...
include::../../includes/oadp-deleting-cluster-resources-following-success.adoc[leveloffset=+2]
include::../../includes/oadp-deleting-cluster-resources-following-failure.adoc[leveloffset=+2]

include::../../includes/oadp-vsb-cleanup-after-scheduler.adoc[leveloffset=+1]
