...
You configure GCP for Velero, create a default `Secret`, and then install the Data Protection Application. For more details, see xref:oadp-installing-operator-doc[Installing the OADP Operator].
...
include::../../includes/migration-configuring-gcp.adoc[leveloffset=+1]
...
include::../../includes/oadp-gcp-wif-cloud-authentication.adoc[leveloffset=+1]
