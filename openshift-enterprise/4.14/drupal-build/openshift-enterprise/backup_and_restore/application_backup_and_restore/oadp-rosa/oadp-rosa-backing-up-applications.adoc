...
include::../../includes/preparing-aws-credentials-for-oadp.adoc[leveloffset=+1]

include::../../includes/installing-oadp-rosa-sts.adoc[leveloffset=+1]
...
include::../../includes/performing-a-backup-oadp-rosa-sts.adoc[leveloffset=+2]
include::../../includes/cleanup-a-backup-oadp-rosa-sts.adoc[leveloffset=+2]
