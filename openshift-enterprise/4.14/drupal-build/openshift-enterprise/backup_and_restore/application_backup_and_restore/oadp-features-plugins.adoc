...
include::../includes/oadp-features.adoc[leveloffset=+1]
include::../includes/oadp-plugins.adoc[leveloffset=+1]
include::../includes/oadp-configuring-velero-plugins.adoc[leveloffset=+1]
include::../includes/oadp-plugins-receiving-eof-message.adoc[leveloffset=+2]
include::../includes/oadp-supported-architecture.adoc[leveloffset=+1]
...
include::../includes/oadp-ibm-power-test-support.adoc[leveloffset=+2]
include::../includes/oadp-ibm-z-test-support.adoc[leveloffset=+2]

include::../includes/oadp-fips.adoc[leveloffset=+1]
