...
include::../../includes/virt-preventing-nvidia-gpu-operands-from-deploying-on-nodes.adoc[leveloffset=+2]

[id="virt-preparing-host-devices-for-pci-passthrough"]
== Preparing host devices for PCI passthrough

include::../../includes/virt-about-pci-passthrough.adoc[leveloffset=+2]

include::../../includes/virt-adding-kernel-arguments-enable-iommu.adoc[leveloffset=+2]

include::../../includes/virt-binding-devices-vfio-driver.adoc[leveloffset=+2]

include::../../includes/virt-exposing-pci-device-in-cluster-cli.adoc[leveloffset=+2]

include::../../includes/virt-removing-pci-device-from-cluster-cli.adoc[leveloffset=+2]
...
include::../../includes/virt-assigning-pci-device-virtual-machine.adoc[leveloffset=+2]
