...
include::../../includes/virt-policy-attributes.adoc[leveloffset=+1]

include::../../includes/virt-setting-policy-attributes.adoc[leveloffset=+1]

include::../../includes/virt-schedule-supported-cpu-model-vms.adoc[leveloffset=+1]

include::../../includes/virt-schedule-cpu-host-model-vms.adoc[leveloffset=+1]

include::../../includes/virt-vm-custom-scheduler.adoc[leveloffset=+1]
