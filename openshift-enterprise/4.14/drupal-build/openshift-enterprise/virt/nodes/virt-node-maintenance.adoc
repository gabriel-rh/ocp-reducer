...
include::../includes/virt-configuring-vm-eviction-strategy-cli.adoc[leveloffset=+2]

include::../includes/virt-configuring-cluster-eviction-strategy-cli.adoc[leveloffset=+2]
...
include::../includes/virt-runstrategies-vms.adoc[leveloffset=+2]

include::../includes/virt-configuring-runstrategy-vm.adoc[leveloffset=+2]

include::../includes/virt-maintaining-bare-metal-nodes.adoc[leveloffset=+1]
