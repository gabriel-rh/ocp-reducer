...
include::../includes/virt-creating-layer2-nad-cli.adoc[leveloffset=+2]

include::../includes/virt-creating-localnet-nad-cli.adoc[leveloffset=+2]
...
include::../includes/virt-attaching-vm-to-ovn-secondary-nw-cli.adoc[leveloffset=+2]
