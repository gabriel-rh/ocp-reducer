...
include::../includes/virt-hot-plugging-bridge-network-interface-cli.adoc[leveloffset=+1]

include::../includes/virt-hot-unplugging-bridge-network-interface-cli.adoc[leveloffset=+1]
