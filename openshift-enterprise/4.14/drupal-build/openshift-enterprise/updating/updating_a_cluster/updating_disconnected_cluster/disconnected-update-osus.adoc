...
include::../../includes/disconnected-osus-overview.adoc[leveloffset=+1]
...
include::../../includes/update-service-install-web-console.adoc[leveloffset=+2]

// Installing the OpenShift Update Service Operator by using the CLI
include::../../includes/update-service-install-cli.adoc[leveloffset=+2]
...
include::../../includes/update-service-graph-data.adoc[leveloffset=+1]
...
include::../../includes/update-service-create-service-web-console.adoc[leveloffset=+2]

// Creating an OpenShift Update Service application by using the CLI
include::../../includes/update-service-create-service-cli.adoc[leveloffset=+2]
...
include::../../includes/update-service-configure-cvo.adoc[leveloffset=+3]
