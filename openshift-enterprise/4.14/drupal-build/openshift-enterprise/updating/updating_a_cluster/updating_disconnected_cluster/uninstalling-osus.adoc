...
include::../../includes/update-service-delete-service-web-console.adoc[leveloffset=+2]

// Deleting an OpenShift Update Service application by using the CLI
include::../../includes/update-service-delete-service-cli.adoc[leveloffset=+2]
...
include::../../includes/update-service-uninstall-web-console.adoc[leveloffset=+2]

// Uninstalling the OpenShift Update Service Operator by using the CLI
include::../../includes/update-service-uninstall-cli.adoc[leveloffset=+2]
