...
include::../includes/update-vsphere-virtual-hardware-on-control-plane-nodes.adoc[leveloffset=+2]

// Updating the virtual hardware for compute nodes on vSphere
include::../includes/update-vsphere-virtual-hardware-on-compute-nodes.adoc[leveloffset=+2]

// Updating the virtual hardware for template on vSphere
include::../includes/update-vsphere-virtual-hardware-on-template.adoc[leveloffset=+2]
...
include::../includes/scheduling-virtual-hardware-update-on-vsphere.adoc[leveloffset=+1]
