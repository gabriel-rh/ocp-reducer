...
// EUS-to-EUS update
include::../includes/updating-eus-to-eus-upgrade.adoc[leveloffset=+1]

// EUS-to-EUS update using the web console
include::../includes/updating-eus-to-eus-upgrade-console.adoc[leveloffset=+2]
...
include::../includes/updating-eus-to-eus-upgrade-cli.adoc[leveloffset=+2]
...
include::../includes/updating-eus-to-eus-layered-products.adoc[leveloffset=+2]
