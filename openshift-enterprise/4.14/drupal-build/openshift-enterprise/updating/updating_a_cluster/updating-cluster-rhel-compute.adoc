...
include::../includes/rhel-compute-about-hooks.adoc[leveloffset=+2]

// Configuring the Ansible inventory file to use hooks
include::../includes/rhel-compute-using-hooks.adoc[leveloffset=+2]

// Available hooks for RHEL compute machines
include::../includes/rhel-compute-available-hooks.adoc[leveloffset=+2]

// Updating {op-system-base} compute machines in your cluster
include::../includes/rhel-compute-updating.adoc[leveloffset=+1]
