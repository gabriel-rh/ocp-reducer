...
include::../includes/update-using-custom-machine-config-pools-about.adoc[leveloffset=+1]

// Creating machine config pools to perform a canary rollout update
include::../includes/update-using-custom-machine-config-pools-mcp.adoc[leveloffset=+1]

// Pausing the machine config pools
include::../includes/update-using-custom-machine-config-pools-pause.adoc[leveloffset=+1]
...
include::../includes/update-using-custom-machine-config-pools-unpause.adoc[leveloffset=+1]

// Moving a node to the original machine config pool
include::../includes/update-using-custom-machine-config-pools-mcp-remove.adoc[leveloffset=+1]
