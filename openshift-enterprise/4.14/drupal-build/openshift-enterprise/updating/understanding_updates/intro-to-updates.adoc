...
include::../includes/update-availability-faq.adoc[leveloffset=+1]
...
include::../includes/determining-upgrade-viability-conditiontype.adoc[leveloffset=+1]

// Understanding cluster version condition types
include::../includes/determining-upgrade-viability-cv-conditiontype.adoc[leveloffset=+1]

// Common terms
include::../includes/update-common-terms.adoc[leveloffset=+1]
