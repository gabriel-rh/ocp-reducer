...
include::includes/kubernetes-components.adoc[leveloffset=+1]

include::includes/kubernetes-resources.adoc[leveloffset=+1]
...
include::includes/kubernetes-conceptual-guidelines.adoc[leveloffset=+1]
