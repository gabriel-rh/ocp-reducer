...
ifndef::openshift-dedicated,openshift-rosa[]
include::includes/monitoring-enabling-the-platform-alertmanager-instance-for-user-defined-alert-routing.adoc[leveloffset=+1]
endif::openshift-dedicated,openshift-rosa[]

// Enabling a dedicated Alertmanager instance for use in user-defined projects
include::includes/monitoring-enabling-a-separate-alertmanager-instance-for-user-defined-alert-routing.adoc[leveloffset=+1]

// Granting users permission to configure alert routing for user-defined projects
include::includes/monitoring-granting-users-permission-to-configure-alert-routing-for-user-defined-projects.adoc[leveloffset=+1]
