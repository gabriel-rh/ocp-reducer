...
include::includes/monitoring-managing-core-platform-alerting-rules.adoc[leveloffset=+1]
include::includes/monitoring-tips-for-optimizing-alerting-rules-for-core-platform-monitoring.adoc[leveloffset=+2]
include::includes/monitoring-creating-new-alerting-rules.adoc[leveloffset=+2]
include::includes/monitoring-modifying-core-platform-alerting-rules.adoc[leveloffset=+2]
...
ifndef::openshift-dedicated,openshift-rosa[]
include::includes/monitoring-applying-custom-alertmanager-configuration.adoc[leveloffset=+1]
endif::openshift-dedicated,openshift-rosa[]
