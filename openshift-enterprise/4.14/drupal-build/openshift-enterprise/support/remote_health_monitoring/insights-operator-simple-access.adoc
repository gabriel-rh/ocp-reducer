...
* See link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/builds_using_buildconfig/#using-red-hat-subscriptions-in-builds[Using Red Hat subscriptions in builds] for more information about using simple content access entitlements in {product-title} builds.
endif::openshift-rosa,openshift-dedicated[]

include::../includes/insights-operator-configuring-sca.adoc[leveloffset=+1]

include::../includes/insights-operator-disabling-sca.adoc[leveloffset=+1]

include::../includes/insights-operator-enabling-sca.adoc[leveloffset=+1]