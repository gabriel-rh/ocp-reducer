...
include::../includes/troubleshooting-disabling-autoreboot-mco.adoc[leveloffset=+1]
include::../includes/troubleshooting-disabling-autoreboot-mco-console.adoc[leveloffset=+2]
include::../includes/troubleshooting-disabling-autoreboot-mco-cli.adoc[leveloffset=+2]
endif::openshift-rosa,openshift-dedicated[]
...
ifndef::openshift-rosa,openshift-dedicated[]
include::../includes/olm-reinstall.adoc[leveloffset=+1]
endif::openshift-rosa,openshift-dedicated[]
