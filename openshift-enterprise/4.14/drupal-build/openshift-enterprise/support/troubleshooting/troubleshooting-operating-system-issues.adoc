...
include::../includes/investigating-kernel-crashes.adoc[leveloffset=+1]

include::../includes/troubleshooting-enabling-kdump.adoc[leveloffset=+2]

include::../includes/troubleshooting-enabling-kdump-day-one.adoc[leveloffset=+2]
...
include::../includes/troubleshooting-debugging-ignition.adoc[leveloffset=+1]
