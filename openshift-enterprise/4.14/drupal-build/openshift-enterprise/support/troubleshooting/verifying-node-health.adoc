...
include::../includes/reviewing-node-status-usage-and-configuration.adoc[leveloffset=+1]

// cannot create resource "namespaces"
ifndef::openshift-rosa,openshift-dedicated[]
// Querying the kubelet's status on a node
include::../includes/querying-kubelet-status-on-a-node.adoc[leveloffset=+1]
