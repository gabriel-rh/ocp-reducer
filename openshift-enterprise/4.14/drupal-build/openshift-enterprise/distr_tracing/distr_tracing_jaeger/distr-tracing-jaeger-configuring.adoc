...
include::../includes/distr-tracing-deploy-default.adoc[leveloffset=+1]

include::../includes/distr-tracing-deploy-production-es.adoc[leveloffset=+1]

include::../includes/distr-tracing-deploy-streaming.adoc[leveloffset=+1]

[id="validating-your-jaeger-deployment"]
== Validating your deployment

include::../includes/distr-tracing-accessing-jaeger-console.adoc[leveloffset=+2]
...
include::../includes/distr-tracing-sidecar-automatic.adoc[leveloffset=+2]

include::../includes/distr-tracing-sidecar-manual.adoc[leveloffset=+2]
