...
include::includes/images-other-jenkins-agent-images.adoc[leveloffset=+1]

include::includes/images-other-jenkins-agent-env-var.adoc[leveloffset=+1]

include::includes/images-other-jenkins-agent-memory.adoc[leveloffset=+1]

include::includes/images-other-jenkins-agent-gradle.adoc[leveloffset=+1]

include::includes/images-other-jenkins-agent-pod-retention.adoc[leveloffset=+1]
