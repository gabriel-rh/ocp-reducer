...
include::includes/builds-disabling-build-strategy-globally.adoc[leveloffset=+1]
include::includes/builds-restricting-build-strategy-globally.adoc[leveloffset=+1]
include::includes/builds-restricting-build-strategy-to-user.adoc[leveloffset=+1]
