...
include::../includes/sbo-creating-a-postgresql-database-instance.adoc[leveloffset=+1]

//Deploying the Spring PetClinic sample application
include::../includes/sbo-deploying-the-spring-petclinic-sample-application.adoc[leveloffset=+1]

//Connecting the Spring PetClinic sample application to the PostgreSQL database service
include::../includes/sbo-connecting-spring-petclinic-sample-app-to-postgresql-database-service.adoc[leveloffset=+1]
