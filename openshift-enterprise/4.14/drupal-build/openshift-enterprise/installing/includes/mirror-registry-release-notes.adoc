...
For an overview of the _mirror registry for Red Hat OpenShift_, see xref:mirror-registry-flags_installing-mirroring-creating-registry[Creating a mirror registry with mirror registry for Red Hat OpenShift].
