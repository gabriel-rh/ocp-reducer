...
include::../includes/cluster-limitations-local-zone.adoc[leveloffset=+1]

[role="_additional-resources"]
.Additional resources

* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/storage/#pvc-storage-class_understanding-persistent-storage[Storage classes]

* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/networking/#nw-ingress-sharding_ingress-sharding[Ingress Controller sharding]
...
include::../includes/installation-user-infra-generate.adoc[leveloffset=+2]
...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/networking/#mtu-value-selection_changing-cluster-network-mtu[Changing the MTU for the cluster network]
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/networking/#nw-ovn-ipsec-enable_configuring-ipsec-ovn[Enabling IPsec encryption]
...
include::../includes/installation-aws-add-local-zone-locations.adoc[leveloffset=+1]

// Cluster installation options for an AWS Local Zone environment
include::../includes/aws-cluster-installation-options-aws-lzs.adoc[leveloffset=+1]

.Next steps

Choose one of the following options to install an {product-title} cluster in an AWS Local Zones environment:

* xref:installation-cluster-quickly-extend-workers_installing-aws-localzone[Installing a cluster quickly in AWS Local Zones]
* xref:creating-aws-local-zone-environment-existing_installing-aws-localzone[Installing a cluster in an existing VPC with defined Local Zone subnets]

// Installing a cluster quickly in AWS Local Zones
include::../includes/installation-cluster-quickly-extend-workers.adoc[leveloffset=+1]

// Modifying an installation configuration to use AWS Local Zones
include::../includes/install-creating-install-config-aws-local-zones.adoc[leveloffset=+2]

[role="_additional-resources"]
.Additional resources

* xref:cluster-limitations-local-zone_installing-aws-localzone[Creating the installation configuration file]

* xref:cluster-limitations-local-zone_installing-aws-localzone[Cluster limitations in AWS Local Zones]

.Next steps
* xref:installation-launching-installer_installing-aws-localzone[Deploying the cluster]
...
include::../includes/installation-creating-aws-vpc-localzone.adoc[leveloffset=+2]
// Creating a subnet in AWS Local Zones
include::../includes/installation-creating-aws-subnet-localzone.adoc[leveloffset=+2]
// CloudFormation template for the VPC
include::../includes/installation-cloudformation-vpc-localzone.adoc[leveloffset=+2]
// AWS security groups
include::../includes/installation-aws-security-groups.adoc[leveloffset=+2]
// CloududFormation template for the subnet that uses AWS Local Zones
include::../includes/installation-cloudformation-subnet-localzone.adoc[leveloffset=+2]
...
include::../includes/install-creating-install-config-aws-local-zones-subnets.adoc[leveloffset=+2]
...
// include::../includes/installation-localzone-generate-k8s-manifest.adoc[leveloffset=+2]
...
.Next steps
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/postinstallation_configuration/#installation-extend-edge-nodes-aws-local-zones_post-install-cluster-tasks[Creating user workloads in AWS Local Zones]
...
include::../includes/machine-edge-pool-review-nodes.adoc[leveloffset=+1]
