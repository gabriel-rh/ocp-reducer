...
include::../includes/installation-special-config-butane.adoc[leveloffset=+1]
include::../includes/installation-special-config-butane-about.adoc[leveloffset=+2]
include::../includes/installation-special-config-butane-install.adoc[leveloffset=+2]
include::../includes/installation-special-config-butane-create.adoc[leveloffset=+2]

[role="_additional-resources"]
.Additional resources

* xref:installation-special-config-kmod_installing-customizing[Adding kernel modules to nodes]
* xref:installation-special-config-storage_installing-customizing[Encrypting and mirroring disks during installation]

include::../includes/installation-special-config-kargs.adoc[leveloffset=+1]
ifdef::openshift-webscale[]
include::modules/installation-special-config-rtkernel.adoc[leveloffset=+1]
endif::openshift-webscale[]
include::../includes/installation-special-config-kmod.adoc[leveloffset=+1]
include::../includes/installation-special-config-storage.adoc[leveloffset=+1]
include::../includes/installation-special-config-raid.adoc[leveloffset=+1]
include::../includes/installation-special-config-chrony.adoc[leveloffset=+1]

[role="_additional-resources"]
== Additional resources

* For information on Butane, see xref:installation-special-config-butane_installing-customizing[Creating machine configs with Butane].

ifndef::openshift-origin[]
* For information on FIPS support, see xref:installing-fips[Support for FIPS cryptography].
endif::[]
