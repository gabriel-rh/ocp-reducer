...
include::../includes/cgroupv2-vs-cgroupv1.adoc[]
...
ifndef::openshift-origin[]
include::../includes/nodes-clusters-cgroups-2-install.adoc[leveloffset=+1]
endif::openshift-origin[]
...
* xref:ocp-installation-overview[OpenShift Container Platform installation overview]
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/nodes/#nodes-clusters-cgroups-2_nodes-cluster-cgroups-2[Configuring the Linux cgroup on your nodes]
