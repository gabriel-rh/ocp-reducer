...
include::../includes/ipi-install-troubleshooting-install-config.adoc[leveloffset=+1]
include::../includes/ipi-install-troubleshooting-bootstrap-vm.adoc[leveloffset=+1]
include::../includes/ipi-install-troubleshooting-bootstrap-vm-cannot-boot.adoc[leveloffset=+2]
include::../includes/ipi-install-troubleshooting-bootstrap-vm-inspecting-logs.adoc[leveloffset=+2]
include::../includes/ipi-install-troubleshooting-cluster-nodes-will-not-pxe.adoc[leveloffset=+1]
include::../includes/ipi-install-troubleshooting_unable-to-discover-new-bare-metal-hosts-using-the-bmc.adoc[leveloffset=+1]
include::../includes/ipi-install-troubleshooting-api-not-accessible.adoc[leveloffset=+1]
include::../includes/ipi-install-troubleshooting_proc_worker-nodes-cannot-join-the-cluster.adoc[leveloffset=+1]
include::../includes/ipi-install-troubleshooting-cleaning-up-previous-installations.adoc[leveloffset=+1]
include::../includes/ipi-install-troubleshooting-registry-issues.adoc[leveloffset=+1]
include::../includes/ipi-install-troubleshooting-misc-issues.adoc[leveloffset=+1]
include::../includes/ipi-install-troubleshooting-failed-ignition-during-firstboot.adoc[leveloffset=+2]
include::../includes/ipi-install-troubleshooting-ntp-out-of-sync.adoc[leveloffset=+2]
include::../includes/ipi-install-troubleshooting-reviewing-the-installation.adoc[leveloffset=+1]
