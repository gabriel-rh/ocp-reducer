...
include::../includes/private-clusters-about-gcp.adoc[leveloffset=+2]

include::../includes/installation-about-custom-gcp-vpc.adoc[leveloffset=+1]
...
* To manage long-term cloud credentials manually, follow the procedure in xref:manually-create-iam_installing-gcp-private[Manually creating long-term credentials].

* To implement short-term credentials that are managed outside the cluster for individual components, follow the procedures in xref:installing-gcp-with-short-term-creds_installing-gcp-private[Configuring a GCP cluster to use short-term credentials].
