...
include::../includes/installation-requirements-user-infra-ibm-z-kvm.adoc[leveloffset=+1]
...
include::../includes/installation-ibm-z-kvm-user-infra-installing-rhcos.adoc[leveloffset=+1]

include::../includes/ibm-z-secure-execution.adoc[leveloffset=+2]
...
include::../includes/ibmz-configure-nbde-with-static-ip.adoc[leveloffset=+2]
...
include::../includes/installation-ibm-z-kvm-user-infra-machines-iso.adoc[leveloffset=+2]

include::../includes/installation-full-ibm-z-kvm-user-infra-machines-iso.adoc[leveloffset=+2]
