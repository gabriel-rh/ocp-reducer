...
include::../includes/agent-install-about-mirroring-for-disconnected-registry.adoc[leveloffset=+1]

include::../includes/agent-install-configuring-for-disconnected-registry.adoc[leveloffset=+2]