...
to a mirror host, use the xref:olm-mirror-catalog_installing-mirroring-installation-images[Mirroring Operator catalogs for use with disconnected clusters] procedure to copy images to a device you can move across network boundaries with.
====
...
include::../includes/olm-mirroring-catalog.adoc[leveloffset=+1]
...
** link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/cli_tools/#cli-opm-install[Installing the opm CLI]
** link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/operators/#olm-filtering-fbc_olm-managing-custom-catalogs[Updating or filtering a file-based catalog image]
...
include::../includes/olm-mirroring-catalog-extracting.adoc[leveloffset=+2]
include::../includes/olm-mirroring-catalog-colocated.adoc[leveloffset=+3]

[role="_additional-resources"]
.Additional resources
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/operators/#olm-arch-os-support_osdk-generating-csvs[Architecture and operating system support for Operators]

include::../includes/olm-mirroring-catalog-airgapped.adoc[leveloffset=+3]

[role="_additional-resources"]
.Additional resources
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/operators/#olm-arch-os-support_osdk-generating-csvs[Architecture and operating system support for Operators]

include::../includes/olm-mirroring-catalog-manifests.adoc[leveloffset=+2]
include::../includes/olm-mirroring-catalog-post.adoc[leveloffset=+2]

[role="_additional-resources"]
.Additional resources

* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/postinstallation_configuration/#post-install-mirrored-catalogs[Populating OperatorHub from mirrored Operator catalogs]
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/operators/#olm-filtering-fbc_olm-managing-custom-catalogs[Updating or filtering a file-based catalog image]
...
xref:installing-restricted-networks-vsphere[VMware vSphere],
xref:installing-restricted-networks-bare-metal[bare metal], or xref:installing-restricted-networks-aws[Amazon Web Services].

[role="_additional-resources"]
[id="restricted-networks-additional-resources"]
== Additional resources

* See link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/support/#gathering-data-specific-features_gathering-cluster-data[Gathering data about specific features] for more information about using must-gather.
