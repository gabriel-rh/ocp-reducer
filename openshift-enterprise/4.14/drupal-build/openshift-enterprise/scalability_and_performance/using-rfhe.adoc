...
include::includes/nw-rfhe-introduction.adoc[leveloffset=+1]

include::includes/nw-rfhe-installing-operator-cli.adoc[leveloffset=+2]

include::includes/nw-rfhe-installing-operator-web-console.adoc[leveloffset=+2]

include::includes/hw-installing-amq-interconnect-messaging-bus.adoc[leveloffset=+1]
...
include::includes/nw-rfhe-creating-bmc-event-sub.adoc[leveloffset=+2]

include::includes/nw-rfhe-quering-redfish-hardware-event-subs.adoc[leveloffset=+2]

include::includes/nw-rfhe-creating-hardware-event.adoc[leveloffset=+2]
...
include::includes/cnf-rfhe-notifications-api-refererence.adoc[leveloffset=+1]
