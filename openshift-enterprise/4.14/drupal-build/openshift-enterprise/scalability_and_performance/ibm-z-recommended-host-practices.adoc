...
include::includes/ibm-z-managing-cpu-overcommitment.adoc[leveloffset=+1]
...
include::includes/ibm-z-disable-thp.adoc[leveloffset=+1]

include::includes/ibm-z-boost-networking-performance-with-rfs.adoc[leveloffset=+1]
...
include::includes/ibm-z-choose-networking-setup.adoc[leveloffset=+1]
...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/nodes/#controlling-pod-placement-on-nodes-using-node-affinity-rules[Controlling pod placement on nodes using node affinity rules]

include::includes/ibm-z-ensure-high-disk-performance-hyperpav.adoc[leveloffset=+1]
...
include::includes/ibm-z-rhel-kvm-host-recommendations.adoc[leveloffset=+1]
