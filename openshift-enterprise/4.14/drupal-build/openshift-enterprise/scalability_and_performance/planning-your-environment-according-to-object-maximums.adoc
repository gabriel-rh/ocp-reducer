...
include::includes/openshift-cluster-maximums-major-releases.adoc[leveloffset=+1]

include::includes/openshift-cluster-maximums-environment.adoc[leveloffset=+1]

include::includes/how-to-plan-your-environment-according-to-cluster-maximums.adoc[leveloffset=+1]

include::includes/how-to-plan-your-environment-according-to-application-requirements.adoc[leveloffset=+1]
