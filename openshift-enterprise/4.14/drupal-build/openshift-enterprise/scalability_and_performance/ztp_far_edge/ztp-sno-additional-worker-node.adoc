...
* For more information about worker nodes, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/nodes/#adding-worker-nodes-to-single-node-openshift-clusters[Adding worker nodes to single-node OpenShift clusters].

include::../includes/ztp-worker-node-applying-du-profile.adoc[leveloffset=+1]

include::../includes/ztp-worker-node-daemon-selector-compatibility.adoc[leveloffset=+1]

include::../includes/ztp-worker-node-node-selector-compatibility.adoc[leveloffset=+1]

include::../includes/ztp-worker-node-preparing-policies.adoc[leveloffset=+1]

include::../includes/ztp-adding-worker-nodes.adoc[leveloffset=+1]
