...
[source,yaml]
----
include::./ztp_SriovOperatorConfig.yaml[]
----
...
[source,yaml]
----
include::./ztp_SriovNetworkNodePolicy.yaml[]
----
...
[source,yaml]
----
include::./ztp_07-sriov-related-kernel-args-master.yaml[]
----
