...
----
---
include::./ztp_StorageNS.yaml[]
---
include::./ztp_StorageOperGroup.yaml[]
----
...
[source,yaml]
----
include::./ztp_ClusterLogNS.yaml[]
include::./ztp_ClusterLogOperGroup.yaml[]
----

.Recommended PTP Operator namespace and Operator group configuration (`PtpSubscriptionNS.yaml`, `PtpSubscriptionOperGroup.yaml`)
[source,yaml]
----
include::./ztp_PtpSubscriptionNS.yaml[]
---
include::./ztp_PtpSubscriptionOperGroup.yaml[]
----
