...
include::includes/node-observability-high-level-workflow.adoc[leveloffset=+1]

include::includes/node-observability-installation.adoc[leveloffset=+1]

include::includes/node-observability-install-cli.adoc[leveloffset=+2]

include::includes/node-observability-install-web-console.adoc[leveloffset=+2]
...
include::includes/node-observability-create-custom-resource.adoc[leveloffset=+2]

include::includes/node-observability-run-profiling-query.adoc[leveloffset=+2]
...
include::includes/node-observability-scripting-cr.adoc[leveloffset=+2]

include::includes/node-observability-scripting.adoc[leveloffset=+2]
