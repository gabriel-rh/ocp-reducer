...
[source,yaml]
----
include::includes/ztp_PerformanceProfile.yaml[]
----
+
include::includes/performance-profile-workload-partitioning.adoc[]
...
* For the recommended workload partitioning configuration for {sno} clusters, see xref:ztp-sno-du-enabling-workload-partitioning_sno-configure-for-vdu[Workload partitioning].
