...
include::includes/setting-up-cpu-manager.adoc[leveloffset=+1]

include::includes/topology-manager-policies.adoc[leveloffset=+1]

include::includes/setting-up-topology-manager.adoc[leveloffset=+1]

include::includes/pod-interactions-with-topology-manager.adoc[leveloffset=+1]
