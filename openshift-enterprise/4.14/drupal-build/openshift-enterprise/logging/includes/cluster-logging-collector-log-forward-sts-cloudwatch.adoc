...
link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/authentication_and_authorization/#about-the-cloud-credential-operator[Cloud Credential Operator(CCO)]
endif::[]
