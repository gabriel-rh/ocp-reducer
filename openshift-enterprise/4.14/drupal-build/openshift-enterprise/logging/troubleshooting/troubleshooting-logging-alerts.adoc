...
[[troubleshooting-logging-alerts-1]]
...
include::../includes/es-cluster-health-is-red.adoc[leveloffset=+1]
...
include::../includes/es-node-disk-low-watermark-reached.adoc[leveloffset=+1]
include::../includes/es-node-disk-high-watermark-reached.adoc[leveloffset=+1]
include::../includes/es-node-disk-flood-watermark-reached.adoc[leveloffset=+1]
...
include::../includes/es-disk-space-low.adoc[leveloffset=+1]
