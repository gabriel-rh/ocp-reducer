...
include::../includes/images-allow-pods-to-reference-images-across-projects.adoc[leveloffset=+1]

include::../includes/images-allow-pods-to-reference-images-from-secure-registries.adoc[leveloffset=+1]

include::../includes/images-pulling-from-private-registries.adoc[leveloffset=+2]
