...
include::includes/samples-operator-overview.adoc[leveloffset=+1]
...
ifndef::openshift-rosa,openshift-dedicated[]
include::includes/samples-operator-configuration.adoc[leveloffset=+1]

include::includes/samples-operator-crd.adoc[leveloffset=+1]
endif::openshift-rosa,openshift-dedicated[]

include::includes/images-samples-operator-deprecated-image-stream.adoc[leveloffset=+1]
