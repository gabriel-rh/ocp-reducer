...
include::../includes/configuring-registry-storage-nutanix.adoc[leveloffset=+2]

include::../includes/installation-registry-storage-non-production.adoc[leveloffset=+2]

include::../includes/installation-registry-storage-block-recreate-rollout-nutanix.adoc[leveloffset=+2]
