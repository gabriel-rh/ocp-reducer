...
include::../includes/registry-configuring-registry-storage-rhodf-cephrgw.adoc[leveloffset=+1]

include::../includes/registry-configuring-registry-storage-rhodf-nooba.adoc[leveloffset=+1]
