...
ifndef::openshift-dedicated,openshift-rosa[]
include::includes/registry-accessing-directly.adoc[leveloffset=+1]
endif::openshift-dedicated,openshift-rosa[]

include::includes/registry-checking-the-status-of-registry-pods.adoc[leveloffset=+1]

include::includes/registry-viewing-logs.adoc[leveloffset=+1]

ifndef::openshift-dedicated,openshift-rosa[]
include::includes/registry-accessing-metrics.adoc[leveloffset=+1]
...
link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/authentication_and_authorization/#removing-the-kubeadmin-user[Removing the kubeadmin user] for
more information.
* For more information on configuring an identity provider, see
link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.14/html-single/authentication_and_authorization/#understanding-identity-provider-configuration[Understanding identity provider configuration].
endif::openshift-dedicated,openshift-rosa[]
