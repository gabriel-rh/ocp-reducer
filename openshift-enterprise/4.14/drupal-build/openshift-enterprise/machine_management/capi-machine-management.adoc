...
include::includes/cluster-api-architecture.adoc[leveloffset=+1]
...
include::includes/capi-yaml-cluster.adoc[leveloffset=+2]
...
include::includes/capi-yaml-infrastructure-aws.adoc[leveloffset=+3]

//Sample YAML for CAPI AWS machine template resource
include::includes/capi-yaml-machine-template-aws.adoc[leveloffset=+3]

//Sample YAML for a CAPI AWS compute machine set resource
include::includes/capi-yaml-machine-set-aws.adoc[leveloffset=+3]
...
include::includes/capi-yaml-infrastructure-gcp.adoc[leveloffset=+3]

//Sample YAML for CAPI GCP machine template resource
include::includes/capi-yaml-machine-template-gcp.adoc[leveloffset=+3]

//Sample YAML for a CAPI GCP compute machine set resource
include::includes/capi-yaml-machine-set-gcp.adoc[leveloffset=+3]

//Creating a CAPI compute machine set
include::includes/capi-machine-set-creating.adoc[leveloffset=+1]

//Troubleshooting clusters that use the Cluster API
include::includes/capi-troubleshooting.adoc[leveloffset=+1]
