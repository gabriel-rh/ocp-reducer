...
//Machine phases
include::includes/machine-about-phases.adoc[leveloffset=+1]

//The machine lifecycle
include::includes/machine-about-lifecycle.adoc[leveloffset=+1]
...
include::includes/machine-determine-phase-cli.adoc[leveloffset=+2]

//Determining the phase of a machine by using the web console
include::includes/machine-determine-phase-gui.adoc[leveloffset=+2]
