...
include::../includes/machineset-yaml-aws.adoc[leveloffset=+1]
...
include::../includes/machineset-aws-existing-placement-group.adoc[leveloffset=+1]

//Machine sets that enable the Amazon EC2 Instance Metadata Service
include::../includes/machineset-imds-options.adoc[leveloffset=+1]

//Creating machines that use the Amazon EC2 Instance Metadata Service
include::../includes/machineset-creating-imds-options.adoc[leveloffset=+2]

//Machine sets that deploy machines as Dedicated Instances
include::../includes/machineset-dedicated-instances.adoc[leveloffset=+1]

//Creating Dedicated Instances by using machine sets
include::../includes/machineset-creating-dedicated-instances.adoc[leveloffset=+2]
...
include::../includes/nvidia-gpu-aws-adding-a-gpu-node.adoc[leveloffset=+1]
