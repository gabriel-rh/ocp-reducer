...
include::../includes/cpmso-failure-domains-provider.adoc[leveloffset=+2]
...
include::../includes/cpmso-failure-domains-balancing.adoc[leveloffset=+2]
...
include::../includes/machine-lifecycle-hook-deletion-etcd.adoc[leveloffset=+1]
[role="_additional-resources"]
.Additional resources
