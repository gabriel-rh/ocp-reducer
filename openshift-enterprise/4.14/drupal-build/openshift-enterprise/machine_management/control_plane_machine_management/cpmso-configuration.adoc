...
include::../includes/cpmso-yaml-sample-cr.adoc[leveloffset=+1]
...
include::../includes/cpmso-yaml-provider-spec-aws.adoc[leveloffset=+2]

//Sample AWS failure domain configuration
include::../includes/cpmso-yaml-failure-domain-aws.adoc[leveloffset=+2]
...
include::../includes/cpmso-yaml-provider-spec-gcp.adoc[leveloffset=+2]

//Sample GCP failure domain configuration
include::../includes/cpmso-yaml-failure-domain-gcp.adoc[leveloffset=+2]
////
...
include::../includes/cpmso-yaml-provider-spec-azure.adoc[leveloffset=+2]

//Sample Azure failure domain configuration
include::../includes/cpmso-yaml-failure-domain-azure.adoc[leveloffset=+2]
...
include::../includes/cpmso-yaml-provider-spec-nutanix.adoc[leveloffset=+2]
...
include::../includes/cpmso-yaml-provider-spec-vsphere.adoc[leveloffset=+2]

//Sample VMware vSphere failure domain configuration
include::../includes/cpmso-yaml-failure-domain-vsphere.adoc[leveloffset=+2]
...
include::../includes/cpmso-yaml-provider-spec-openstack.adoc[leveloffset=+2]

//Sample OpenStack failure domain configuration
include::../includes/cpmso-yaml-failure-domain-openstack.adoc[leveloffset=+2]