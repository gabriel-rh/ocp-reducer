...
//# includes=_attributes/common-attributes,modules/odc-configure-web-terminal-timeout-session,modules/configure-web-terminal-timeout-admin,modules/snippets/access-cluster-configuration-console,modules/odc-configure-web-terminal-image-session,modules/configure-web-terminal-image-admin
