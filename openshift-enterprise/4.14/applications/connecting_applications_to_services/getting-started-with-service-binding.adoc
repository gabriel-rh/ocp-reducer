...
//# includes=_attributes/common-attributes,_attributes/servicebinding-document-attributes,modules/sbo-creating-a-postgresql-database-instance,modules/sbo-deploying-the-spring-petclinic-sample-application,modules/sbo-connecting-spring-petclinic-sample-app-to-postgresql-database-service
